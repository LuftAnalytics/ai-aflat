...
const episodes = [
  {
    ...
    description: "Ce aduce nou GPT-4.5, Claude 3.5 și ce înseamnă pentru business",
    platforms: ["spotify", "apple", "youtube"],
  },
  {
    number: 5,
    title: "Când AI restructurează totul",
    description: "Cum să pregătești echipa pentru automatizare fără haos",
    platforms: ["spotify", "apple", "youtube"],
  },
  {
    number: 4,
    title: "Promptul perfect nu există",
    description: "De ce contextul bate tehnicile de prompt engineering",
    platforms: ["spotify", "apple", "youtube"],
  },
]
