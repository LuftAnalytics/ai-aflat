...
const socialLinks = [
  {
    name: "LinkedIn",
    url: "https://www.linkedin.com/company/111767602",
    icon: (
  ...
  {
    name: "YouTube",
    url: "https://www.youtube.com/@aiaflatpodcast",
    icon: (
      <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: "TikTok",
    url: "https://www.tiktok.com/@ai_aflat_podcast",
    icon: (
      <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: "Facebook",
    url: "https://www.facebook.com/profile.php?id=61587939167496",
    icon: (
      <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: "Spotify",
    url: "https://open.spotify.com/show/62QsfbjV2FjS9wnxvhxpkL",
    icon: (
      <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: "Apple Podcasts",
    url: "https://podcasts.apple.com/us/podcast/ai-aflat/id1877735682",
    icon: (
      <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: "Instagram",
    url: "https://www.instagram.com/aiaflatpodcast",
    icon: (
      <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: "Patreon",
    url: "https://www.patreon.com/c/AIAFLATPodcast",
    icon: (
      <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
